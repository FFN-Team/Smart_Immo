...
ifndef::pustylefile[:pustylefile: ../../commons.style]
...
==== Grande fonctionnalité 1 : Générer des statistiques pour les agents immobiliers
...
plantuml::{modelsdir}/v0.0.3/gf_statistics_estate_agents/dc.pu[svg,config="{pustylefile}"]
