...
public class DocumentController {
    ...
    @Operation(description = "Upload file into Google Drive.",
            responses = {
                    ...
                    @ApiResponse(responseCode = "400", description = "File name not specified."),
    ...
    public ResponseEntity<DocumentResponse> uploadFile(
        ...
        var documentResponse = new DocumentResponse(file.getName(), file.getDocumentId(), file.getWebContentLink(),
                file.getWebLink());
    ...
    public ResponseEntity<Folder> createFolder(@RequestBody String name) {
        if (isNull(name)) throw new BadRequestException(DOCUMENT_NAME_NOT_SPECIFIED,
